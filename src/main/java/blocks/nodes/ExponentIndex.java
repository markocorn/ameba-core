...
//* @author Marko
//*/
//public class ExponentIndex extends Node implements Serializable {
//    //Properties
//    //Random generator
...
//
//    //Constructor
//    public ExponentIndex(double par, double exp) {
//        this.par = par;
//        nodeExpression = exp;
//    }
//
...
//                    outValue = Math.pow(Math.abs(inpEdges.get(0).getValue()), par) * nodeExpression;
//                    clcFlg = true;
//                    outFlg = true;
//                }
//            } else {
...
//            out += states.get(this);
//        } else {
//            out += "a_{" + id + "}^{" + inpEdges.get(0).getSource().getTxt(states);
//            out += "}";
//        }
//        return out;
//    }
...
//        String out = "a_{" + id + "}^{";
//        out += inpEdges.get(0).getSource().getTxt(states);
//        out+="}";
//        return  out;
//    }
//}
