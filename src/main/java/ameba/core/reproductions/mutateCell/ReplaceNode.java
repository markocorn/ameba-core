...
//        Node nodeNew = nodeFactory.genNodeRnd();
        ...
        //Number of edges is smaller than minimum number of edges of new node
        if (nodeOld.getInputEdges().size() < nodeNew.getMinInputEdges()) {
            //Reconnect old edges to new node
            ...
            //Remaining edges to minimum constrain satisfaction must be generated
        ...
        //Number of edges ig greater than minimum number of edges and smaller than max number of edges
        ...
        //Number of edges is greater than maximum number of edges of new node
        if (nodeOld.getInputEdges().size() > nodeNew.getMaxInputEdgesDec()) {
            ...
            //Rest of the edges has to be deleted or reconnected
