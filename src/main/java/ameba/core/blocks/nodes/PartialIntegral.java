...
//* @author Marko
//*/
//public class PartialIntegral extends Node implements Serializable {
//    //Properties
//    //Input edges
//    private ArrayList<Edge> inpEdges;
//    //Output edges
...
//    private double oldValueInput2 = 0;
...
//
//    //Constructor
//    public PartialIntegral(double exp, double intValue) {
//        this.initValue=intValue;
//        nodeExpression = exp;
//        oldValue = intValue;
//        outFlg = true;
//        outValue = intValue;
//        inpEdges = new ArrayList();
//    }
//
...
//                    outValue = (oldValue + inpEdges.get(0).getValue() * (inpEdges.get(1).getValue() - oldValueInput2));
//                    oldValue = outValue;
//                    oldValueInput2 = inpEdges.get(1).getValue();
