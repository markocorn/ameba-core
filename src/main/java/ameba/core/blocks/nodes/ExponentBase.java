...
//* @author Marko
//*/
//public class ExponentBase extends Node implements Serializable {
//    //Properties
//    //Random generator
...
//
//    //Constructor
//    public ExponentBase(double par, double exp) {
//        this.par = par;
//        nodeExpression = exp;
//    }
//
...
//                    outValue = Math.pow(Math.abs(par), inpEdges.get(0).getValue()) * nodeExpression;
//                    clcFlg = true;
//                    outFlg = true;
//                }
//            } else {
...
//        this.par = new Double((Double) par);
//    }
//
//    @Override
//    public Node copy() {
...
//            out += states.get(this);
//        } else {
//            out += "("+ inpEdges.get(0).getSource().getTxt(states) +")^{a_{" + id + "}}" ;
//        }
//        return out;
//    }
//
...
//        String out = "("+ inpEdges.get(0).getSource().getTxt(states) +")^{a_{" + id + "}}" ;
//        return  out;
//    }
//
//}
