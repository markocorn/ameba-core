 ...
 * @author Marko
 */
public class FilterLPDec extends NodeMem {
    ...
    @Override
    public void clcNode() {
        getCollectorsSourceDec().get(0).setSignal(signalOld + getParamsDec().get(0) * (getCollectorsTargetDec().get(0).getSignal() - signalOld));
