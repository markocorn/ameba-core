...
// * @author Marko
// */
//public class Derivative extends Node implements Serializable {
//    //Properties
//    //Random generator
...
//
//    //Constructor
//    public Derivative(double par, double intValue, double exp) {
...
//                    outValue = (inpEdges.get(0).getValue() - oldValue) / par;
//                    oldValue = inpEdges.get(0).getValue();
