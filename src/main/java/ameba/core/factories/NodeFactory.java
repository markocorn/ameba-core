...
//
//    /**
//     * Get list of nodes that are allowed for usage and their maximum input connections is greater or equal to first input variable and their minimum output connections is greater or equal to second input variable.
//     *
//     * @param numInputs
//     * @param numOutputs
//     * @return
...
//
//    /**
//     * Get list of nodes that are allowed for usage and their maximum input connections is greater or equal to first input variable and their minimum output connections is greater or equal to second input variable and is not of type of third input variable.
//     *
//     * @param numInputs
//     * @param numOutputs
//     * @param nodeType
