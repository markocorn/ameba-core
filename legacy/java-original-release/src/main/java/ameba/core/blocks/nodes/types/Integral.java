 ...
 * @author Marko
 */
public class Integral extends NodeMem {
    private double initValue;
    private double signalOld;


    public Integral(double initial, Double par, Double[] parLimits) throws Exception {
    ...
    @Override
    public void clcNode() {
        getCollectorsSource().get(0).setSignal(getCollectorsTarget().get(0).getSignal() * getParamsDec().get(0) + signalOld);
